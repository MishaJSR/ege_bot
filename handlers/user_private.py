...
#     if not await check_input(message, UserState):
#         return
#     await message.answer(f'Вы выбрали раздел', reply_markup=start_kb()[0])
    # try:
...
@user_private_router.message(UserState.subj_choose, F.text == "Основная часть")
